    ...
    private static void installSilent(String filePath, String pmParams, Context mContext, PackageManager packageManager){
        ...
        try {
            ...
            if (result.successMsg != null
                ...
                //com.deepreality.appinstallsilent
                //com.deepreality.advertising_setting
                Intent intent = packageManager.getLaunchIntentForPackage("com.deepreality.advertising_setting");
