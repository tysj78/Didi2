...
// ECoderStatus appwidget_info are identical to ELzmaStatus appwidget_info of LZMA2 decoder
...
// ECoderFinishMode appwidget_info are identical to ELzmaFinishMode
